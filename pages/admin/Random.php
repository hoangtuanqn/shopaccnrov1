                        ...
                        <div class="table-responsive">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    foreach($TUANORI->get_list(" SELECT * FROM `category_game` WHERE `type` = 'random' ORDER BY stt ASC ") as $row){
                                    ?>
                                    <tr>
                                        <td><?=++$i;?></td>
                                        ...
                                        <td>
                                            <a aria-label="" href="/Admin/EditRandom/<?=$row['id'];?>" style="color:white;" class="btn btn-primary btn-sm btn-icon-left m-b-10" type="button">
                                                <i class="fas fa-edit mr-1"></i><span class="">Edit</span>
                                            </a>
                                            <a aria-label="" href="<?=BASE_URL('Admin/Randoms/'.$row['id']);?>" style="color:white;" class="btn btn-info btn-sm btn-icon-left m-b-10" type="button">
...
<script type="text/javascript">
    function postRemove(id,username) {
        $.ajax({
            url: "/controller/admin/DeleteRandom.php",
            type: 'POST',
            dataType: "JSON",
            data: {
                id: id
