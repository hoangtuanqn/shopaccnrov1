    ...
    <section class="content">
        ...
        <section class="col-lg-6"></section>
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <textarea rows="5" name="listacc"
                                            ...
                                            class="form-control"></textarea>
                                        <i>Áp dụng cho random, thêm nhiều tài khoản 1 lần</i>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="number" value="0" name="giamgia" class="form-control fnum">
            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h3 class="card-title">200 DANH SÁCH TÀI KHOẢN GẦN ĐÂY</h3>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                                    class="fas fa-minus"></i>
                            </button>
                        ...
                        <div class="table-responsive">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    foreach($TUANORI->get_list(" SELECT * FROM `list_acc_game` WHERE `category_game` = '".check_string($_GET['id'])."'  ORDER BY id DESC LIMIT 200") as $row){
                                    ?>
                                    <tr>
                                        <td width="5%"><?=++$i;?></td>
                                        ...
                                        <td>
                                            ...
                                            <a aria-label="" href="<?=BASE_URL('Admin/Random/Edit/'.$row['id']);?>" style="color:white;" class="btn btn-info btn-sm btn-icon-left m-b-10" type="button">
