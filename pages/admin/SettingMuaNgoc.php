<?php
    ...
    $title = 'CẤU HÌNH HỆ SỐ | '.$TUANORI->site('title');
...
$tuan = json_decode($TUANORI->site('server_banngoc'), true);
?>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h3 class="card-title">CẤU HÌNH ĐỊA CHỈ BÁN/RÚT NGỌC</h3>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Tình trạng bán ngọc</label>
                                        <select class="custom-select" name="status_banngoc">
                                            <option value="0" <?=($TUANORI->site('status_banngoc') == 0) ? 'selected' : '';?>>Đóng</option>
                                            <option value="1" <?=($TUANORI->site('status_banngoc') == 1) ? 'selected' : '';?>>Mở bán</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="min_banngoc" class="form-control fnum" value="<?=format_cash($TUANORI->site('min_banngoc'));?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Số tiền mua tối đa</label>
                                        <input type="text" name="max_banngoc" class="form-control fnum" value="<?=format_cash($TUANORI->site('max_banngoc'));?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Hệ số bán ng ọc máy chủ</label>
