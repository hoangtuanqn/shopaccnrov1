...
if(isset($_POST['btnUpload'])) {
    ...
    if($status == 4 && $row['ctv']) {
        msg_error_ad("Đã có người nhận đơn hàng này, nếu ADMIN muốn nhận, vui lòng đổi tên CTV thành của mình", "", 5000);
    }
    if($status == 1 && $row['ctv']) {
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <section class="col-lg-6">
            <div class="mb-3">
                <a class="btn btn-danger btn-icon-left m-b-10" href="<?=BASE_URL('Partner/DonDichVu');?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <i style="color: green; font-weight: bold">Bạn sẽ chỉ nhận được <?=(100 - $TUANORI->site('ctv_dichvu'));?>% giá tiền khi hoàn thành đơn này</i>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="status">
                                            <?php if($row['ctv'] == $getUser['username']) { ?>
                                                ...
                                                <option value="5" <?=($row['status'] == 5) ? 'selected' : ''?>>Không nhận đơn này</option>
                                            <?php } else { ?>
                                                <?php if(!$row['ctv']) { ?>
