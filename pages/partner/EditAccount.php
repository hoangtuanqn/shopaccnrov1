...
<?php
if(isset($_GET['id'])) {
    $row = $TUANORI->get_row(" SELECT * FROM `list_acc_game` WHERE `id` = '".check_string($_GET['id'])."' AND `ctv` = '".$getUser['username']."' ");
    if(!$row) {
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <section class="col-lg-6">
            <div class="mb-3">
                <a class="btn btn-danger btn-icon-left m-b-10" href="<?=BASE_URL('Partner/Accounts/'.$row['category_game']);?>"
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Trạng thái <?php if($row['username'] != NULL) {
